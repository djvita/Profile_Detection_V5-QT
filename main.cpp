...
/**
*@file
*@brief This is the main of the application that recognizes people.
* \n This application was developed by: Shervin Emami (http://www.shervinemami.info) on 30th May 2012.
* \n "WebcamFaceRec. Face Detection & Face Recognition from a webcam using LBP and Eigenfaces or Fisherfaces."
* \n\n This application was entirely used as it was, and it was only augmented for the project purposes.
* \n\n The added features consisted in storing the added faces in files; assigning a profile
* \n for each face (and storing them in a text file); and indicating the currently detected face
* and its profile (in a text file).
*/
...
//**********************************************
    ...
    printf( "Time = %g ms;\n %1.0f ms/frame -> %1.1f FPS\n", t/((double)cvGetTickFrequency()*1000.) , t/1000000, 1000000000/t);
